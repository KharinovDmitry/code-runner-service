...
run_python_executor:
	docker run --rm --mount type=bind,source=./internal/executor/python/testFiles,target=/home/tmp --name test.py -i -e FILE_NAME=test.py python_executor ./unprivrun 3000 1000 python3 tmp/test.py
